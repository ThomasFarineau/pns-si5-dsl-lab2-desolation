...
export const setupConfigExtended = () => {
    ...
    const textmateConfigUrl = new URL('../syntaxes/midi-dsl.tmLanguage.json', window.location.href);
    extensionFilesOrContents.set('/language-configuration.json', languageConfigUrl);
    extensionFilesOrContents.set('/midi-dsl-grammar.json', textmateConfigUrl);
